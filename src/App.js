...
import { SafeAreaView, View, FlatList, StyleSheet, ScrollView, Dimensions, Text, TouchableOpacity, Image } from 'react-native';
...
function App() {
    ...
    const renderProductCard = ({ item, index }) => <ProductCard shop={item} />
    return (
